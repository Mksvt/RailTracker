...
import { getUpdateColor } from '../lib/helpers';
import { getUpdateIcon } from '../lib/iconHelpers';
      ...
      <div className="space-y-4 max-h-[600px] overflow-y-auto">
        {updates.length === 0 && !isLoading ? (
          ...
          updates.map((update, index) => (
            <div
              key={update.id}
              className={`border-l-4 ${getUpdateColor(
                update.type
              )} bg-secondary/30 p-3 rounded-r-lg slide-in`}
